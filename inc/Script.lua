...
[قنـاة سورس الشيـخ  ارماندو •](t.me/EEl00)
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/hkem0hedr/Nizkfile/master/GetVersion.txt' ) or 0
...
return '• اصدار سورس الشيـخ ارماندو : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'• ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس الشيـخ ارماندو يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
send_key(msg.sender_user_id_,'   [قناة سورس : الشيـخ ارماندو](https://t.me/EEl00)' ,nil,inline,msg.id_)
return false
end
...
return [[
•سـورس الشيـخ ارماندو•

 [•ارماندو ياشيخ •](t.me/EEFFI)

 [ • سـورس الشيـخ ارماندو • ](t.me/EEl00)
 
 [•بوت تواصل •](t.me/F96BOT)
ٴ━━━━━━━━━━
]]
end
...
• اختـصاصـي حمايـة الـمجموعات
•من التكـرار والسـبام وبوتـات التفـليش ومـن الشـير الايرانـي والخ
[قنـاة سورس الشيـخ ارماندو ارماندو •](t.me/EEl00)
...
elseif Text== "ارماندو يا شيخ" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس الشيـخ  ارماندو •](https://t.me/EEFFI)")
...
‏
  ...
  --=====================================
  elseif Text== "ارماندو" or Text== "اباظه" or Text=="باسل" then
...
return sendMsg(msg.chat_id_,msg.id_,"مطور سورس الشيخ ارماندو يا عضو•")
end 
end 
