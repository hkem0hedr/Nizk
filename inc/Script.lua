...
send_key(msg.sender_user_id_,'   [قناة سورس : الشيـخ](https://t.me/EEl00)' ,nil,inline,msg.id_)
return false
end
...
return [[
ـ سـورس الشيـخ ارماندو •

 [ـ الشيخ ارماندو •](t.me/EEFFI)

 [ ـ سورس ارماندو • ](t.me/EEl00)
 
  [ ـ تواصل السورس • ](t.me/F96BOT)
ٴ━━━━━━━━━━
]]
end
...
elseif Text== "ارماندو يا شيخ" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس الشيـخ↯](https://t.me/VVVIP)")
...
‏
  ...
  --=====================================
  elseif Text== "ارماندو" or Text== "حيدر" or Text=="حيدر" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"ـ مطور السورس ")
...
return sendMsg(msg.chat_id_,msg.id_,"ـ مطور سورس الشيخ يا عضو •")
end 
end 
